...
using FreshMvvmEnterpriseWizard.Styles;
...
namespace FreshMvvmEnterpriseWizard.Services
{
    public class VSStyleValuesProvider : BaseStyleValuesProvider
    {
        ...
        public override Brush GetColor(string className, string memberName)
        {
            ...
            return new System.Windows.Media.SolidColorBrush(new Color()
            {
                A = color.A,
                R = color.R,
                G = color.G,
        ...
        public override System.Drawing.Color GetThemedColor(string className, string memberName)
        {
            ...
            switch (className)
            {
                ...
                case "InfoBar":
                    ...
                    break;
                case "FreshTemplateBuilder":
                    classType = typeof(FreshTemplateBuilderColors);
                    break;
